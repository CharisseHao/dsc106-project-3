...
<p>
During the initial team meeting, we decided on the Yelp dataset before brainstorming potential questions. We dedicated approximately 12 hours to this project. Our team divided tasks amongst ourselves to efficiently collaborate on our project together. Charisse took charge of EDA by categorizing the businesses, as well as dropping states with too few businesses and states, not from the U.S.. She added axis labels and values to each bar, which eventually changed to a tooltip, and she added the write-up to the final website. Nicole assisted with loading the data, added hover animations, helped debug errors on the graph, added CSS styles to the website, and helped edit the write-up. Jenna helped with website style debugging, researching other examples of how our particular visualization was implemented, and writing the write-up. The process of creating the visualization and figuring out the data formatting took the most time. Overall, the development process involved collaboration through creativity in finding ways to implement our visualization by overcoming challenges in data formatting issues and optimizing the interface for better readability and interactivity. 
</p>
